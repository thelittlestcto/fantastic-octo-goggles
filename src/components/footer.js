  ...
  <Container as="footer">
    <div className={styles.footer}>
      <div className={styles.footerGrid}>
        <div className={styles.footerGridItem}>&nbsp;</div>
        <div className={styles.footerGridItem}></div>
        <div className={styles.footerGridItem}>&nbsp;</div>
        <div className={styles.footerGridItem}>&nbsp;</div>
        <div className={styles.footerGridItemBig}>
          <div className={styles.contactIconsContainer}>
            <a
              href="mailto:alex@thelittlestcto.com"
            ...
            <a
              href="https://uk.linkedin.com/in/axshaw"
            ...
            <a
              href="https://twitter.com/axshaw"
              aria-label="Alex on Twitter"
              rel="noopener noreferrer"
              target="_blank"
            >
              <svg
        ...
        <div className={styles.footerGridItemBigLinks}>
          <a
            className={styles.boyneylink}
            href="https://www.boyney.io/"
            rel="noopener noreferrer"
            target="_blank"
          >
            Site &amp; me inspired by @boyney123
          </a>
        </div>
      </div>
    </div>
